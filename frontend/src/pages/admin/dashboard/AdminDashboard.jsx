...
const AdminDashboard = () => {
  ...
  const recentBookings = [
    { id: 1, customer: 'John Doe', service: 'Premium Wash', date: '2025-01-15', time: '10:00 AM', status: 'pending' },
    { id: 2, customer: 'Jane Smith', service: 'Basic Wash', date: '2025-01-15', time: '2:00 PM', status: 'confirmed' },
    { id: 3, customer: 'Mike Johnson', service: 'Full Detailing', date: '2025-01-16', time: '9:00 AM', status: 'pending' },
    { id: 4, customer: 'Sarah Wilson', service: 'Engine Clean', date: '2025-01-16', time: '11:30 AM', status: 'confirmed' },
    { id: 5, customer: 'Tom Brown', service: 'Wax & Polish', date: '2025-01-17', time: '3:00 PM', status: 'pending' },
  ];
  ...
  const totalBookings = serviceBookingData.reduce((sum, item) => sum + item.bookings, 0);
      ...
      <div className="p-8 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
        <div className="max-w-[1400px] mx-auto space-y-8">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-6">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-600 mt-2">Welcome back, {currentAdmin?.name || `${currentAdmin?.first_name} ${currentAdmin?.last_name}` || currentAdmin?.email}</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <CardContent className="pt-0">
                ...
                <p className="text-sm text-blue-700">All registered users</p>
            ...
            <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
                <CardTitle className="text-base font-semibold text-green-900">Total Bookings</CardTitle>
              ...
              <CardContent className="pt-0">
                <div className="text-3xl font-bold text-green-900 mb-2">{totalBookings}</div>
            ...
            <Card className="bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <CardContent className="pt-0">
                <div className="text-3xl font-bold text-orange-900 mb-2">{pendingBookings}</div>
            ...
            <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
                <CardTitle className="text-base font-semibold text-purple-900">Active Customers</CardTitle>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <Card className="xl:col-span-2 bg-white rounded-2xl shadow-lg border border-gray-200">
              <CardHeader className="pb-4">
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-xl font-bold text-gray-900">Service Booking Analytics</CardTitle>
                    <CardDescription className="text-gray-600 mt-1">Number of bookings per service type</CardDescription>
                  </div>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={350}>
                  <BarChart data={serviceBookingData} margin={{ top: 20, right: 30, left: 20, bottom: 60 }}>
            ...
            <div className="space-y-8">
              <Card className="bg-white rounded-2xl shadow-lg border border-gray-200">
                <CardHeader>
                  <CardTitle className="text-lg font-bold text-gray-900">Service Distribution</CardTitle>
                  <CardDescription className="text-gray-600">Service type breakdown</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl shadow-lg border border-gray-200">
                ...
                <CardContent className="space-y-3">
                  ...
                  <Button variant="outline" className="w-full border-gray-300 hover:bg-gray-50 rounded-xl py-3 font-medium">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
